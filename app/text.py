...
trash_succeeded = 'Draft successfully trashed'
...
show_archiveds = "Show ONLY messages that I've already read/archived"
show_alls = 'Show ALL messages'
show_days = "Show ONLY archived messages from the last 24 hours"
show_this_weeks = "Show ONLY this week's archived messages"
show_pinneds = 'Show ONLY my pinned messages'
